...
| tt-telemetry.image.tag | string | `"0.1.3"` | tt-telemetry image tag. Keep in lockstep with the tt-telemetry subchart version in Chart.yaml. renovate: datasource=docker depName=ghcr.io/tenstorrent/tt-telemetry |
